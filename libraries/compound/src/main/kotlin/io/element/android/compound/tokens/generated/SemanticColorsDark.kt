...
val compoundColorsDark = SemanticColors(
    ...
    bgBadgeAccent = DarkColorTokens.colorClapBgBadgeAccent,
    bgBadgeDefault = DarkColorTokens.colorClapBgBadgeDefault,
    ...
    bgSubtleSecondary = DarkColorTokens.colorClapBgSubtleSecondary,
    ...
    borderInteractivePrimary = DarkColorTokens.colorClapIconAccentTertiary,
    ...
    iconAccentTertiary = DarkColorTokens.colorClapIconAccentTertiary,
    ...
    iconOnSolidPrimary = DarkColorTokens.colorClapThemeBg,
    ...
    textBadgeAccent = DarkColorTokens.colorClapTextBadgeAccent,
    ...
    textPrimary = DarkColorTokens.colorClapTextPrimary,
    textSecondary = DarkColorTokens.colorClapTextSecondary,
    textSuccessPrimary = DarkColorTokens.colorGreen900,

    // Clap Design System Colors
    clapBgBubbleIncoming = DarkColorTokens.colorClapBgBubbleIncoming,
    clapBgBubbleOutgoing = DarkColorTokens.colorClapBgBubbleOutgoing,
    clapTextBubbleIncoming = DarkColorTokens.colorClapTextBubbleIncoming,
    clapTextBubbleOutgoing = DarkColorTokens.colorClapTextBubbleOutgoing,
    clapTextBubbleSecondaryIncoming = DarkColorTokens.colorClapTextBubbleSecondaryIncoming,
    clapTextBubbleSecondaryOutgoing = DarkColorTokens.colorClapTextBubbleSecondaryOutgoing,
    clapIconBubbleIncoming = DarkColorTokens.colorClapIconBubbleIncoming,
    clapIconBubbleOutgoing = DarkColorTokens.colorClapIconBubbleOutgoing,
    clapBgCodeBlockIncoming = DarkColorTokens.colorClapBgCodeBlockIncoming,
    clapBgCodeBlockOutgoing = DarkColorTokens.colorClapBgCodeBlockOutgoing,
    clapTextCodeBlockIncoming = DarkColorTokens.colorClapTextCodeBlockIncoming,
    clapTextCodeBlockOutgoing = DarkColorTokens.colorClapTextCodeBlockOutgoing,
    clapBgPollProgressEmptyIncoming = DarkColorTokens.colorClapBgPollProgressEmptyIncoming,
    clapBgPollProgressEmptyOutgoing = DarkColorTokens.colorClapBgPollProgressEmptyOutgoing,
    clapBgPollProgressFilledIncoming = DarkColorTokens.colorClapBgPollProgressFilledIncoming,
    clapBgPollProgressFilledOutgoing = DarkColorTokens.colorClapBgPollProgressFilledOutgoing,
    clapThemeBg = DarkColorTokens.colorClapThemeBg,
    clapBgSubtleSecondary = DarkColorTokens.colorClapBgSubtleSecondary,
    clapTextPrimary = DarkColorTokens.colorClapTextPrimary,
    clapTextSecondary = DarkColorTokens.colorClapTextSecondary,
    clapIconAccentTertiary = DarkColorTokens.colorClapIconAccentTertiary,
    clapTextBadgeAccent = DarkColorTokens.colorClapTextBadgeAccent,
    clapBgBadgeAccent = DarkColorTokens.colorClapBgBadgeAccent,
    clapBgBadgeDefault = DarkColorTokens.colorClapBgBadgeDefault,
    bgCanvasClap = DarkColorTokens.colorClapThemeBg,
