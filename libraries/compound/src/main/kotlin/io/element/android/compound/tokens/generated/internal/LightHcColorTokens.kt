...
object LightHcColorTokens {
    ...
    val colorClapBgBubbleIncoming = Color(0xFFFEFFFF)
    val colorClapBgBubbleOutgoing = Color(0xFF292524)
    val colorClapTextBubbleIncoming = Color(0xFF1C1917)
    val colorClapTextBubbleOutgoing = Color(0xFFFEFFFF)
    val colorClapTextBubbleSecondaryIncoming = Color(0xFF6F6964)
    val colorClapTextBubbleSecondaryOutgoing = Color(0xD9FFFFFF)
    val colorClapIconBubbleIncoming = Color(0xFF706965)
    val colorClapIconBubbleOutgoing = Color(0xB3FFFFFF)
    val colorClapBgCodeBlockIncoming = Color(0x0F000000)
    val colorClapBgCodeBlockOutgoing = Color(0x33000000)
    val colorClapTextCodeBlockIncoming = Color(0xFF1C1917)
    val colorClapTextCodeBlockOutgoing = Color(0xFFFEFFFF)
    val colorClapBgPollProgressEmptyIncoming = Color(0x4D000000)
    val colorClapBgPollProgressEmptyOutgoing = Color(0x4DFFFFFF)
    val colorClapBgPollProgressFilledIncoming = Color(0xFF000000)
    val colorClapBgPollProgressFilledOutgoing = Color(0xFFFFFFFF)
    val colorClapThemeBg = Color(0xFFEFEEEA)
    val colorClapBgSubtleSecondary = Color(0xE6F5F5F4)
    val colorClapTextPrimary = Color(0xFF181818)
    val colorClapTextSecondary = Color(0xFF666666)
    val colorClapIconAccentTertiary = Color(0xFFF59E0B)
    val colorClapTextBadgeAccent = Color(0xFF92400E)
    val colorClapBgBadgeAccent = Color(0xFFFEF3C7)
    val colorClapBgBadgeDefault = Color(0xFFCDD3DA)
}
