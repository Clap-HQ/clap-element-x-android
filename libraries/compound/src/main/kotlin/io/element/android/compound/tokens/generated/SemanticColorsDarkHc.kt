...
val compoundColorsHcDark = SemanticColors(
    ...
    bgBadgeAccent = DarkHcColorTokens.colorClapBgBadgeAccent,
    bgBadgeDefault = DarkHcColorTokens.colorClapBgBadgeDefault,
    ...
    bgSubtleSecondary = DarkHcColorTokens.colorClapBgSubtleSecondary,
    ...
    borderInteractivePrimary = DarkHcColorTokens.colorClapIconAccentTertiary,
    ...
    iconAccentTertiary = DarkHcColorTokens.colorClapIconAccentTertiary,
    ...
    iconOnSolidPrimary = DarkHcColorTokens.colorClapThemeBg,
    ...
    textBadgeAccent = DarkHcColorTokens.colorClapTextBadgeAccent,
    ...
    textPrimary = DarkHcColorTokens.colorClapTextPrimary,
    textSecondary = DarkHcColorTokens.colorClapTextSecondary,
    textSuccessPrimary = DarkHcColorTokens.colorGreen900,

    // Clap Design System Colors
    clapBgBubbleIncoming = DarkHcColorTokens.colorClapBgBubbleIncoming,
    clapBgBubbleOutgoing = DarkHcColorTokens.colorClapBgBubbleOutgoing,
    clapTextBubbleIncoming = DarkHcColorTokens.colorClapTextBubbleIncoming,
    clapTextBubbleOutgoing = DarkHcColorTokens.colorClapTextBubbleOutgoing,
    clapTextBubbleSecondaryIncoming = DarkHcColorTokens.colorClapTextBubbleSecondaryIncoming,
    clapTextBubbleSecondaryOutgoing = DarkHcColorTokens.colorClapTextBubbleSecondaryOutgoing,
    clapIconBubbleIncoming = DarkHcColorTokens.colorClapIconBubbleIncoming,
    clapIconBubbleOutgoing = DarkHcColorTokens.colorClapIconBubbleOutgoing,
    clapBgCodeBlockIncoming = DarkHcColorTokens.colorClapBgCodeBlockIncoming,
    clapBgCodeBlockOutgoing = DarkHcColorTokens.colorClapBgCodeBlockOutgoing,
    clapTextCodeBlockIncoming = DarkHcColorTokens.colorClapTextCodeBlockIncoming,
    clapTextCodeBlockOutgoing = DarkHcColorTokens.colorClapTextCodeBlockOutgoing,
    clapBgPollProgressEmptyIncoming = DarkHcColorTokens.colorClapBgPollProgressEmptyIncoming,
    clapBgPollProgressEmptyOutgoing = DarkHcColorTokens.colorClapBgPollProgressEmptyOutgoing,
    clapBgPollProgressFilledIncoming = DarkHcColorTokens.colorClapBgPollProgressFilledIncoming,
    clapBgPollProgressFilledOutgoing = DarkHcColorTokens.colorClapBgPollProgressFilledOutgoing,
    clapThemeBg = DarkHcColorTokens.colorClapThemeBg,
    clapBgSubtleSecondary = DarkHcColorTokens.colorClapBgSubtleSecondary,
    clapTextPrimary = DarkHcColorTokens.colorClapTextPrimary,
    clapTextSecondary = DarkHcColorTokens.colorClapTextSecondary,
    clapIconAccentTertiary = DarkHcColorTokens.colorClapIconAccentTertiary,
    clapTextBadgeAccent = DarkHcColorTokens.colorClapTextBadgeAccent,
    clapBgBadgeAccent = DarkHcColorTokens.colorClapBgBadgeAccent,
    clapBgBadgeDefault = DarkHcColorTokens.colorClapBgBadgeDefault,
    bgCanvasClap = DarkHcColorTokens.colorClapThemeBg,
